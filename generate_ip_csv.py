...
def main():
    ...
    dbip_filename = "dbip-country-lite.csv"
    ito_website_excel_filename = "Intranet-Websites.xls"
    ito_im_excel_filename = "Intranet-Messengers.xls"
    ...
    content_networks = [{"name": "Pornography", "tag": "XX"}]
    ...
    if os.path.exists(data_dir_path):
        for network in geo_networks:
            ...
            if network["tag"] == "IR":
                ...
                ito_df = convert_xls_to_df(
                    f"{data_dir_path}/{ito_website_excel_filename}"
                )
